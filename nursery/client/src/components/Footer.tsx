        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/plants" className="text-muted-foreground hover:text-primary transition-colors">
                  Shop All Plants
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/coupons" className="text-muted-foreground hover:text-primary transition-colors">
                  Offers & Coupons
                </Link>
              </li>
              <li>
